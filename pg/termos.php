...
style="background-color: #6a45ea; background-image: url(publico/img/crossword.png);">
    
    <div class="container">
        <div class="row">
            <div class="col-12">
			<h2 style="text-shadow: 4px 3px 5px rgba(0,0,0,0.3); word-wrap: break-word;" class="white-text m-0">Termos de serviços & privacidade</h2>
            </div>
        </div>
    </div>
</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				...
				<p>A sua privacidade é importante para nós. É política da ESTN Consulting Lda, respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="./">Construvision</a>. e outros sites que possuímos e operamos.</p>
				...
				<ul>  
					...
					<p>Esta política é efetiva a partir de <strong>Novembro</strong>/<strong>2022</strong>.</p>
