							...
							<div class="row m-0 justify-content-center">
								<div class="col-12 col-md-5">
									...
									<div class="input-group mb-2 card-body-search">
										<input type="hidden" name="uber_reservas">
							...
							<div class="row justify-content-center">
								<div class="col-12 mt-2 p-0">
									...
									if (isset($_GET['filtro']) && $_GET['filtro'] !=''):
										...
										$select = "SELECT * from uber_reservas WHERE id LIKE '%$busca%'";
										$select.= " OR registo LIKE '%$busca%' ORDER BY id DESC";
									else:
										$select = 'SELECT * from uber_reservas ORDER BY id DESC';
									endif;
									...
									if($contar > 0){
										...
										$paginacao->queryString = 'uber_reservas';
										...
										if (isset($pg) && $pg > 1):
											echo '<script type="text/javascript">location.href = "./?uber_reservas";</script>';
											exit();
										endif;
...
<script src="assets/js/uber/reserva.js"></script>