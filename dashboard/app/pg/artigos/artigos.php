                        ...
                        <ul class="list-inline mb-0">
                            <?php 
                                if(isset($_GET['edit']) || isset($_GET['view']) || isset($_GET['new'])):
                                    ?>
                                        <li><a href="./?artigos" class="mr-2"><i class="ft-box"></i></a></li>
                                    <?php
                                else:
                                    ?>
                                    <li>
                                        <a href="./?artigos&new" class="mr-2">
                                            <i class="ft-plus"></i>
                                        </a>
                                    </li>
                        ...
                        <div class="container">
                            <?php
                                if (isset($_GET['new']) || isset($_GET['edit'])):
                                    include_once 'app/pg/artigos/new.php';

                                elseif(isset($_GET['view'])):
                                    include_once 'app/pg/artigos/view.php';

                                else:
                                    include_once 'app/pg/artigos/itens.php';
