  ...
  <div class="col-12 col-md-5">
    <form method="GET">
      <div class="input-group mb-2 card-body-search">
        <input type="hidden" name="artigos">
...
<div class="row justify-content-center">
    ...
    <?php
      ...
      if (isset($_GET['filtro']) && $_GET['filtro'] !=''):
        ...
        $select = "SELECT * from artigos WHERE nome LIKE '%$busca%'";
      ...
      if($contar > 0){
        ...
        '<div class="custom-control custom-checkbox">
          <input type="checkbox" class="custom-control-input" id="artigo-id">
          <label class="custom-control-label" for="artigo-id"></label>
        </div>'
        );
        ...
        <tr <?= isset($mostra->estado) && $mostra->estado == 0 ? 'class="table-secondary"' : ''; ?>>
          ...
          <td><?php echo get_moeda($mostra->preco); ?></td>
          ...
          <th>
            <div class="d-flex w-100 align-items-center">
              <div class="custom-control custom-checkbox d-inline-block">
                ...
                artigo-select="<?php echo $mostra->id; ?>"
                id="artigo-<?php echo $mostra->id; ?>">
                
                <label 
                class="custom-control-label" 
                for="artigo-<?php echo $mostra->id; ?>"></label>
              </div>
              
              <a href="?artigos&edit=<?php echo $mostra->id; ?>"><i class="las la-edit" data-id="<?php echo $mostra->id; ?>"></i></a>
              <a href="?artigos&view=<?php echo $mostra->id; ?>"><i class="las la-eye" data-id="<?php echo $mostra->id; ?>"></i></a>	
        ...
        if (isset($pg) && $pg > 1):
          echo '<script type="text/javascript">location.href = "./?artigos";</script>';
          exit(); 
        endif;
...
<script src="assets/js/artigo/artigo.js"></script>