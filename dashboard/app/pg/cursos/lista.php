...
<div class="row justify-content-center">
    ...
    <?php
      ...
      if (isset($_GET['filtro']) && $_GET['filtro'] !=''):
        ...
        $select = "SELECT * from curso WHERE titulo LIKE '%$busca%'";
        $select.= " OR registo LIKE '%$busca%' ORDER BY id DESC";
      else:
        $select = 'SELECT * from curso ORDER BY id DESC';
      endif;
      ...
      if($contar > 0){
        ...
        '<div class="custom-control custom-checkbox">
          <input type="checkbox" class="custom-control-input" id="cursos-id">
          <label class="custom-control-label" for="cursos-id"></label>
        </div>'
        );
          ...
          <th>
            <div class="d-flex w-100 align-items-center">
              <div class="custom-control custom-checkbox d-inline-block">
                ...
                cursos-select="<?php echo $mostra->id; ?>"
                id="cursos-<?php echo $mostra->id; ?>">
                
                <label 
                class="custom-control-label" 
                for="cursos-<?php echo $mostra->id; ?>"></label>
              </div>
              
              <a href="?cursos&edit=<?php echo $mostra->id; ?>"><i class="las la-edit" data-id="<?php echo $mostra->id; ?>"></i></a>
              <a href="?cursos&curso=<?php echo $mostra->id; ?>"><i class="las la-eye" data-id="<?php echo $mostra->id; ?>"></i></a>	
        ...
        if (isset($pg) && $pg > 1):
          echo '<script type="text/javascript">location.href = "./?cursos";</script>';
          exit(); 
        endif;
...
<script src="assets/js/cursos/cursos.js"></script>