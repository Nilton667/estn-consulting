								...
								<div class="col-12 col-md-5">
									<form method="GET">
										<div class="input-group mb-2 card-body-search">
											<input type="hidden" name="cursos_pendentes">
							...
							<div class="row justify-content-center">
								<div class="col-12 mt-2 p-0">
									...
									if (isset($_GET['filtro']) && $_GET['filtro'] !=''):
										...
										$select = "SELECT * from cursos_pendentes WHERE id LIKE '%$busca%'";
										$select.= " ORDER BY id DESC";
									else:
										$select = 'SELECT * from cursos_pendentes ORDER BY id DESC';
									endif;
									...
									if($contar > 0){
										...
										while($mostra = $result->FETCH(PDO::FETCH_OBJ)){
                                            @$curso    = json_decode(getCursoId($mostra->id_curso), true);
                                            @$cliente  = json_decode(getCliente($mostra->id_usuario), true);
										?>
										<tr class="<?= $mostra->estado == 1 ? 'table-success' : ''; ?>">
											<th scope="row"><?php echo $mostra->id; ?></th>
                                            <td><?= is_array($curso)   ? $curso[0]['titulo'] : 'n/a'; ?></td>
                                            <td><?= is_array($cliente) ? $cliente[0]['nome'].' '.$cliente[0]['sobrenome'] : 'n/a'; ?></td>
											<td><?php echo get_moeda($curso[0]['preco']);  ?></td>
										...
										$paginacao->queryString = 'cursos_pendentes';
										...
										if (isset($pg) && $pg > 1):
											echo '<script type="text/javascript">location.href = "./?cursos_pendentes";</script>';
											exit(); 
										endif;
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
            ...
            <ul class="list-group">
                <li class="list-group-item p-1">#ID: <span id="confirm-fatura"></span></li>
            </ul>
        </div>
...
<script src="assets/js/cursos/pendente.js"></script>