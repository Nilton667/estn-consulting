...
<div class="row justify-content-center">
	<div class="col-12 mt-2 p-0">
		...
		if (isset($_GET['filtro']) && $_GET['filtro'] !=''):
			...
			$select = "SELECT * from city WHERE city LIKE '%$busca%'";
		...
		if($contar > 0){
			...
			'<div class="custom-control custom-checkbox">
				<input type="checkbox" class="custom-control-input" id="city-id">
			...
			$table.= trim('
			    <th scope="col">#</th>
			    <th scope="col">Cidade/Província</th>
			...
			<tr <?= isset($mostra->estado) && $mostra->estado == 0 ? 'class="table-secondary"' : ''; ?>>
                ...
                <td id="city-nome-<?php echo $mostra->id; ?>">
                    <?php echo $mostra->city; ?>
                </td>
				...
				<th>
					<div class="d-flex w-100 align-items-center">
						<div class="custom-control custom-checkbox d-inline-block">
							...
							city-select="<?php echo $mostra->id; ?>"
							id="city-<?php echo $mostra->id; ?>">
							
							<label 
							class="custom-control-label" 
							for="city-<?php echo $mostra->id; ?>"></label>
						</div>
						
						<a href="?city&edit=<?= $mostra->id; ?>">
							<i class="las la-edit" data-id="<?php echo $mostra->id; ?>"></i>
						</a>

						<a href="?city&view=<?= $mostra->id; ?>"><i class="las la-eye" data-id="1"></i></a>	                                        		
					</div>
				</th>
			</tr>
			<?php
			...
			if (isset($pg) && $pg > 1):
				echo '<script type="text/javascript">location.href = "./?city";</script>';
				exit(); 
			endif;
...
<script src="assets/js/turismo/city.js"></script>