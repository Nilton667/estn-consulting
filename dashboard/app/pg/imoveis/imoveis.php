  ...
  <div class="col-12 col-md-5">
    <form method="GET">
      <div class="input-group mb-2 card-body-search">
        <input type="hidden" name="imoveis">
...
<div class="row justify-content-center">
    ...
    <?php
      ...
      if (isset($_GET['filtro']) && $_GET['filtro'] !=''):
        ...
        $select = "SELECT * from imoveis WHERE titulo LIKE '%$busca%'";
        $select.= " OR registo LIKE '%$busca%' ORDER BY id DESC";
      else:
        $select = 'SELECT * from imoveis ORDER BY id DESC';
      endif;
      ...
      if($contar > 0){
        ...
        '<div class="custom-control custom-checkbox">
          <input type="checkbox" class="custom-control-input" id="imoveis-id">
          <label class="custom-control-label" for="imoveis-id"></label>
        </div>'
        );
          ...
          <th>
            <div class="d-flex w-100 align-items-center">
              <div class="custom-control custom-checkbox d-inline-block">
                ...
                imoveis-select="<?php echo $mostra->id; ?>"
                id="imoveis-<?php echo $mostra->id; ?>">
                
                <label 
                class="custom-control-label" 
                for="imoveis-<?php echo $mostra->id; ?>"></label>
              </div>
              
              <a href="?imoveis&edit=<?php echo $mostra->id; ?>"><i class="las la-edit" data-id="<?php echo $mostra->id; ?>"></i></a>
              <a href="?imoveis&view=<?php echo $mostra->id; ?>"><i class="las la-eye" data-id="<?php echo $mostra->id; ?>"></i></a>		
        ...
        if (isset($pg) && $pg > 1):
          echo '<script type="text/javascript">location.href = "./?imoveis";</script>';
          exit(); 
        endif;
...
<script src="assets/js/imoveis/imoveis.js"></script>