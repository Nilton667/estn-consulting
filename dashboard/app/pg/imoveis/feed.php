                        ...
                        <ul class="list-inline mb-0">
                            <?php 
                                if(isset($_GET['edit']) || isset($_GET['view']) || isset($_GET['new'])):
                                    ?>
                                        <li><a href="./?imoveis" style="font-size: 1.4em;" class="mr-2"><i class="las la-warehouse"></i></a></li>
                                    <?php
                                else:
                                    ?>
                                    <li>
                                        <a href="./?imoveis&new" class="mr-2">
                                            <i class="ft-plus"></i>
                                        </a>
                                    </li>
                        ...
                        <div class="container">
                            <?php
                                if (isset($_GET['new']) || isset($_GET['edit'])):
                                    include_once 'app/pg/imoveis/new.php';

                                elseif(isset($_GET['view'])):
                                    include_once 'app/pg/imoveis/view.php';

                                else:
                                    include_once 'app/pg/imoveis/imoveis.php';
