  ...
  <div class="col-12 col-md-5">
    <form method="GET">
      <div class="input-group mb-2 card-body-search">
        <input type="hidden" name="servicos_list">
...
<div class="row justify-content-center">
    ...
    <?php
      ...
      if (isset($_GET['filtro']) && $_GET['filtro'] !=''):
        ...
        $select = "SELECT * from servicos WHERE nome LIKE '%$busca%'";
        $select.= " OR registo LIKE '%$busca%' ORDER BY id DESC";
      else:
        $select = 'SELECT * from servicos ORDER BY id DESC';
      endif;
      ...
      if($contar > 0){
        ...
        '<div class="custom-control custom-checkbox">
          <input type="checkbox" class="custom-control-input" id="servicos_list-id">
          <label class="custom-control-label" for="servicos_list-id"></label>
        </div>'
        );
          ...
          <th>
            <div class="d-flex w-100 align-items-center">
              <div class="custom-control custom-checkbox d-inline-block">
                ...
                servicos_list-select="<?php echo $mostra->id; ?>"
                id="servicos_list-<?php echo $mostra->id; ?>">
                
                <label 
                class="custom-control-label" 
                for="servicos_list-<?php echo $mostra->id; ?>"></label>
              </div>
              
              <a href="?servicos_list&edit=<?php echo $mostra->id; ?>"><i class="las la-edit" data-id="<?php echo $mostra->id; ?>"></i></a>
              <a href="?servicos_list&view=<?php echo $mostra->id; ?>"><i class="las la-eye" data-id="<?php echo $mostra->id; ?>"></i></a>
        ...
        $paginacao->queryString = 'servicos_list';
        ...
        if (isset($pg) && $pg > 1):
          echo '<script type="text/javascript">location.href = "./?servicos_list";</script>';
          exit(); 
        endif;
...
<script src="assets/js/servicos/servicos_list.js"></script>