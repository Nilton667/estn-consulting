...
<div class="content-header row">
    <div class="content-header-left col-md-4 col-12 mb-2">
        <h3 class="content-header-title mt-2 mb-0">Facturas</h3>
    </div>
</div>
							...
							<div class="row m-0 justify-content-center">
								<div class="col-12 col-md-5">
									...
									<div class="input-group mb-2 card-body-search">
										<input type="hidden" name="servicos_factura">
							...
							<div class="row justify-content-center">
								<div class="col-12 mt-2 p-0">
									...
									if (isset($_GET['filtro']) && $_GET['filtro'] !=''):
										...
										$select = "SELECT * from servicos_reservas WHERE id LIKE '%$busca%' OR data LIKE '%$busca%'";
										$select.= " OR registo LIKE '%$busca%' ORDER BY id DESC";
									else:
										$select = 'SELECT * from servicos_reservas ORDER BY id DESC';
									endif;
									...
									if($contar > 0){
										...
										while($mostra = $result->FETCH(PDO::FETCH_OBJ)){
											...
											@$servicoDada      = json_decode(getServico($mostra->id_servico, ''), true);
										...
										?>">
                                            ...
                                            <td>
											<?= is_array($servicoDada) ? $servicoDada[0]['nome'] : DEFAULT_STRING; ?>
                                            </td>
											...
											<th>
												...
												data-id="<?= $mostra->id; ?>"
												data-total="<?= get_moeda($servicoDada[0]['preco']); ?>"></i>
										...
										$paginacao->queryString = 'servicos_factura';
										...
										if (isset($pg) && $pg > 1):
											echo '<script type="text/javascript">location.href = "./?servicos_factura";</script>';
											exit(); 
										endif;
...
<script src="assets/js/servicos/reserva.js"></script>