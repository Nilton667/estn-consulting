                        ...
                        <ul class="list-inline mb-0">
							<?php
								if(isset($_GET['edit']) || isset($_GET['new'])){
									...
									?>
									<li>
										<a href="?transmicao&new" class="mr-2">
											<i class="ft-plus"></i>
										</a>
                            		</li>
                    ...
                    <div class="card-body">                        
						<?php
							if (isset($_GET['new']) || isset($_GET['edit'])):
								include_once 'app/pg/transmicao/transmicao_new.php';
							else:
												...
												<tr>
													...
													<th>
														<div class="d-flex w-100 align-items-center">
															...
															<a href="?transmicao&edit=<?php echo $mostra->id; ?>">
